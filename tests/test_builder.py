...
from adblock_merge.builder import (
    ...
    render_shadowrocket_module_text,
...
"""
    ...
    def test_render_shadowrocket_module_text_adds_header_rule_section_and_reject_policy(self):
        rendered = render_shadowrocket_module_text(
            [
                ParsedRule("DOMAIN-SUFFIX", "example.com"),
                ParsedRule("DOMAIN-KEYWORD", "tracker"),
            ],
        ...
        self.assertEqual(
            rendered,
            "#!name=Adblock Rule Merge Part 1\n"
    ...
    def test_split_rendered_lines_keeps_each_part_under_limit(self):
        ...
        parts = split_rendered_lines(lines, part_count=3, max_bytes=70, headers=["", "", ""])
